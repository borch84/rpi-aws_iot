...
class Application(dbus.service.Object):
    ...
    def __init__(self, bus):
        ...
        self.add_service(WifiService(bus, 2))
...
class WifiService(Service):
    ...
    WIFI_SVC_UUID = '000000ff-0000-1000-8000-00805f9b34fb' #Tiene que ser el mismo UUID que aparece en el ESP32. 


    def __init__(self, bus, index):
        Service.__init__(self, bus, index, self.WIFI_SVC_UUID, True)
        self.add_characteristic(ssid_characteristic(bus, 0, self))
        self.add_characteristic(ssidpass_characteristic(bus, 1, self))


class ssid_characteristic(Characteristic):

    SSID_CHRC_UUID = '0000ff02-0000-1000-8000-00805f9b34fb'
    ...
    def ReadValue(self, options):
        print('ssid_characteristic Read: ' + repr(self.value))
        return self.value
...
class ssidpass_characteristic(Characteristic):
    ...
    SSIDPASS_CHRC_UUID = '0000ff03-0000-1000-8000-00805f9b34fb'

    def __init__(self, bus, index, service):
        Characteristic.__init__(
                self, bus, index,
                self.SSIDPASS_CHRC_UUID,
                ['read', 'write'],
                service)
        self.value = []

    def ReadValue(self, options):
        print('ssidpass_characteristic Read: ' + repr(self.value))
        return self.value
